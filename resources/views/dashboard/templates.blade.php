...
<body class="h-full flex flex-col bg-white dark:bg-white text-slate-900 overflow-hidden uppercase">
    ...
    <nav class="h-20 bg-slate-950 backdrop-blur-md border-b border-white/10 flex items-center justify-between px-6 sticky top-0 z-30">
        <div class="flex items-center space-x-4">
            ...
            <span class="text-slate-600 font-light text-xl italic font-inter">/</span>
            <a href="{{ route('dashboard.clients') }}" class="text-xs font-black text-white hover:text-pink-400 transition-colors uppercase font-inter">Clients</a>
            <span class="text-slate-600 font-light text-xl italic font-inter">/</span>
            <a href="{{ route('dashboard.templates') }}" class="text-xs font-black text-pink-500 hover:text-white transition-colors uppercase font-inter">Templates</a>
        </div>
        <div class="flex items-center space-x-4">
