...
<body class="h-full flex flex-col bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-200 overflow-hidden">
    ...
    <!-- Navbar -->
    <nav class="h-20 bg-slate-900/50 dark:bg-indigo-900/80 backdrop-blur-md border-b border-slate-800/50 flex items-center justify-between px-6 sticky top-0 z-30">
