...
<body class="h-full flex flex-col bg-white dark:bg-white text-slate-900 dark:text-slate-900 overflow-hidden">
    ...
    <script>
        ...
        const countryData = {
            ...
            french: { france: ['Paris', 'Lyon'], canada: ['Montreal', 'Quebec City'], belgium: ['Brussels'], switzerland: ['Geneva'], senegal: ['Dakar'], ivory_coast: ['Abidjan'], cameroon: ['Yaounde', 'Douala'], congo: ['Kinshasa', 'Brazzaville'], madagascar: ['Antananarivo'], morocco: ['Casablanca'], algeria: ['Algiers'], tunisia: ['Tunis'], haiti: ['Port-au-Prince'], french_guiana: ['Cayenne'], guadeloupe: ['Basse-Terre', 'Pointe-à-Pitre'], martinique: ['Fort-de-France'], reunion: ['Saint-Denis'], mayotte: ['Mamoudzou'], french_polynesia: ['Papeete'], new_caledonia: ['Noumea'] },
        ...
        const countryNames = {
            ...
            french: { france: 'France', canada: 'Canada (FR)', belgium: 'Belgium', switzerland: 'Switzerland', senegal: 'Senegal', ivory_coast: 'Ivory Coast', cameroon: 'Cameroon', congo: 'Congo', madagascar: 'Madagascar', morocco: 'Morocco (FR)', algeria: 'Algeria (FR)', tunisia: 'Tunisia (FR)', haiti: 'Haiti', french_guiana: 'French Guiana', guadeloupe: 'Guadeloupe', martinique: 'Martinique', reunion: 'Réunion', mayotte: 'Mayotte', french_polynesia: 'French Polynesia', new_caledonia: 'New Caledonia' },
