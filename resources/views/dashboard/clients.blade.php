...
<body class="h-full flex flex-col bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-200 overflow-hidden uppercase">
    ...
    <!-- Navbar -->
    <nav class="h-20 bg-white/50 dark:bg-indigo-900/900 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 flex items-center justify-between px-6 sticky top-0 z-30">
                                ...
                                <td class="px-8 py-6">
                                    @if($client->last_email_sent_at)
                                        <div class="flex items-center gap-2">
                                            <p class="text-xs font-semibold text-slate-300 bg-indigo-600/20 border border-indigo-500/30 rounded-lg px-3 py-1">{{ $client->last_email_sent_at->format('d/m/Y') }}</p>
